...
export const ServerChannel = ({ channel, server, role }: ServerChannelProps) => {
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        'group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-accent/90 transition mb-1',
    ...
    >
      ...
      <p
        className={cn(
          ...
          params?.channelId === channel.id && 'text-accent-foreground dark:text-accent-foreground'
        )}
      >
        {channel.name}
      </p>
